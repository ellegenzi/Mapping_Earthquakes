...
// Deliverable 3: Add a third map style to your earthquake map.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
  ...
  L.geoJson(data, {
      ...
      // Turn each feature into a circleMarker on a map
      pointToLayer: function(feature, latlng) {
        console.log(data);
        return L.circleMarker(latlng);
      },
  ...
  // Add the major earthquake layer group variable you created in Step 1 to the map and then close the GeoJSON layer
  }).addTo(majorEQ);
...
legend.onAdd = function() {
  ...
  // Add the tectonic layer group variable created in Step 1 to the map and close the geoJSON layer
